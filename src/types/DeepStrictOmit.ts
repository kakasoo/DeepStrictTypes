    ...
    >
                ...
                : Array<
                      __DeepStrictOmit<
                          ...
                          GetElementMember<
                              K,
                              key
                          > extends DeepStrictObjectKeys<Element>
        ...
        ? key extends string
            ? T[key] extends Date
                ...
                : __DeepStrictOmit<
                      T[key],
                      GetElementMember<K, key> extends DeepStrictObjectKeys<
                          T[key]
                      >
                          ? GetElementMember<K, key>
                          : never
...
export type DeepStrictOmit<
    T extends object,
    K extends DeepStrictObjectKeys<DeepStrictUnbrand<T>>
> = _DeepStrictOmit<DeepStrictUnbrand<T>, K>;
